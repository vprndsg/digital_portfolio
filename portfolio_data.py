...
PROJECTS = [
    ...
    },
    {
        ...
        "summary": "I curate special events end to end: I source the chef, shape the guest experience, build the email and ticket path, coordinate rentals and outreach, run the event, and follow up to sell the featured wines.",
    ...
    },
    {
        ...
        "homepage_summary": "I use social media to promote special events, new wines, and cultivate brand culture.",
    ...
    },
    {
        ...
        "homepage_subtitle": "I build product, splash, and event page updates that support merchandising, launches, and hospitality moments.",
        "homepage_summary": "",
